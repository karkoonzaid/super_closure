...
class SerializerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testUnserializingFailsWithInvalidSignature()
    {
        ...
        $unserializedData = unserialize($serializedFn);
        $unserializedData[1] = '6119dcd1245df749d162b544d4f44280eef3e7f4d4c636611ed87e7b97198c0b';
        $serializedFn = serialize($unserializedData);
    ...
    public function testSerializingAndUnserializingWithSignature()
    {
        ...
        $unserializedData = unserialize($serializedFn);
        $this->assertInternalType('array', $unserializedData);
        $this->assertCount(2, $unserializedData);
